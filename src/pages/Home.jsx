...
import { IconArrowRight, IconBallFootball, IconMountain, IconRun } from "@tabler/icons-react";
      ...
      <main className="home-page">
        ...
        <section className="camping">
          <div data-aos="fade-up" className="img">
            <img className="campfire" src="https://www.icegif.com/wp-content/uploads/2022/09/icegif-1610.gif" alt="campfire" />
          </div>
          <h2 data-aos="zoom-in-up">PRODUCTOS QUE TE ACOMPAÑAN EN TODOS TUS VIAJES</h2>
        </section>

        <section className="about">
          <div className="image"></div>
          <article data-aos="fade-down" data-aos-offset="300" data-aos-easing="ease-in-sine">
            <h2>¿Quiénes Somos?</h2>
            <p>
